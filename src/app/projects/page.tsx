...
import { ExternalLink, Layers, Code, Sparkles, Folder } from 'lucide-react';
                  ...
                  <CardHeader className="relative">
                    <div className="flex justify-between items-start mb-5">
                      ...
                      <div className="flex gap-3.5">
                        <a href={project.github} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors duration-200" title="GitHub Repository">
                          <Github className="w-5 h-5" />
                          <span className="sr-only">GitHub Repository</span>
                        </a>
                        <a href={project.demo} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-emerald-400 transition-colors duration-200" title="Live Demo">
